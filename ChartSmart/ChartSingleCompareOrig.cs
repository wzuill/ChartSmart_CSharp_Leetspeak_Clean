...
namespace ChartSmart
{
    public partial class ChartSingleCompareOrig : Form
    {
        ...
        public const string DISPLAY_TYPE_LARGE = "rpfll";
        ...
        private void RenderChart(Graphics g, ChartData chartData)
        {
            ...
            {
                RenderBarChart(g, chartData);
            }
            else
            {
                RenderPieChart(g, chartData);
            }
        }

        private static void RenderPieChart(Graphics g, ChartData chartData)
        {
        ...
        private void RenderBarChart(Graphics g, ChartData chartData)
        {
